                                       ...
                                       real init, BinaryOp binary_op)
{
  ...
  hipLaunchKernelGGL((THCTensor_kernel_scanOuterDim<real>), grid, threads, 0, THCState_getCurrentStream(state),
                                           ...
                                           BinaryFunction binary_op)
{
  ...
  hipLaunchKernelGGL((THCTensor_kernel_scanInnermostDim<real, 16, 32>), grid, threads, 0, THCState_getCurrentStream(state),
