 ...
 *****************************************************************************/
    ...
    struct equal_to_value
	{
        ...
        explicit
        equal_to_value(const T &targetValue) restrict(cpu, amp)
        ...
        ~equal_to_value() restrict(cpu, amp) {}
        private:
            T _targetValue;
     };
    ...
    struct not_pred
    {
        not_pred() = default;
        explicit
		not_pred(const predicate &targetPred) restrict(cpu, amp)
            : _targetPred(targetPred)
        { };
